...
if __name__ == "__main__":
    download_to_csv()
    matplotlib_show(pandas.read_csv(os.path.join(CSV_DIR, "sp500_monthly_change.csv")))
    matplotlib_show(pandas.read_csv(os.path.join(CSV_DIR, "sp500_weekly_change.csv")))
